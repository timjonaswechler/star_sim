...
fn main() {
    ...
    println!("   Velocity: {} (≈60 km/h converted to km/s)", velocity_kmh.value());
    ...
    println!("   Acceleration (alt syntax): {} (9.81 m/s²)", accel2.value());
    ...
    println!("   Earth orbital velocity: {:.0} m/s", orbital_velocity.value());
