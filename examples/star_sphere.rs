// PROTOTYPE: interactive stellar sphere with Bevy 0.19 Feathers controls.
...
fn main() {
    App::new()
        ...
        .add_systems(Update, (update_star, capture_preview_once))
        .run();
}
...
fn setup(
    ...
    commands.spawn((
        ...
        MeshMaterial3d(materials.add(procedural_star_surface_material(emission))),
    ));
